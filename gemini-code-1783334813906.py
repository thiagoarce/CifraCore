content = """# Análise de Riscos e Problemas Conhecidos - CifraCore
...
with open("cifracore-riscos.md", "w", encoding="utf-8") as f:
    f.write(content)

print("File written successfully: cifracore-riscos.md")